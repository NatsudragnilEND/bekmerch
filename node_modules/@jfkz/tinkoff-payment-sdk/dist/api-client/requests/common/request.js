...
const buildSendRequestFunction = function (url, RequestSchema = [], ResponseSchema = [], transformLambda) {
    return async (options) => {
        const { apiClient } = options;
        const restPayload = __rest(options.payload, []);
        let $payload = Object.assign({}, restPayload);
        if (transformLambda) {
            $payload = Object.assign(Object.assign({}, $payload), transformLambda(restPayload));
        }
