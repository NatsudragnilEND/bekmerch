...
})(ReceiptPaymentMethod || (exports.ReceiptPaymentMethod = ReceiptPaymentMethod = {}));
...
})(ReceiptPaymentObject || (exports.ReceiptPaymentObject = ReceiptPaymentObject = {}));
var ReceiptTax;
(function (ReceiptTax) {
...
})(ReceiptTax || (exports.ReceiptTax = ReceiptTax = {}));
var ReceiptTaxation;
...
})(ReceiptTaxation || (exports.ReceiptTaxation = ReceiptTaxation = {}));
...
})(AgentDataAgentSign || (exports.AgentDataAgentSign = AgentDataAgentSign = {}));
//===========//
// UTILITIES //
//===========//
...
function validateAndPrepareReceiptItem(item) {
    ...
    $item.Price = (0, money_1.moneyToPennyOrThrow)($item.Price);
    //----------//
    // QUANTITY //
    //----------//
    if ($item.Quantity <= 0) {
